...
if __name__ == "__main__":
    jsonfilePath = "/home/daichang/Desktop/myWS/yolov8_teeth/ultralytics/dataset/rgb"  # 要转换的json文件所在目录
    resultDirPath = "/home/daichang/Desktop/myWS/yolov8_teeth/ultralytics/dataset/rgb"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath, classList=["upteeth","lowteeth"]) # 更改为自己的类别名
